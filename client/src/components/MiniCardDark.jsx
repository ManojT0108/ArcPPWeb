...
export default function MiniCardDark({ label, value, fullHeight, link, variant = 'dark' }) {
  ...
  return (
    <div style={{
      ...
      padding: '18px 20px',
      background: isLight
        ? 'linear-gradient(180deg, rgba(255,255,255,0.9), rgba(240,245,255,0.9))'
        : 'linear-gradient(180deg, rgba(26,34,54,.65), rgba(9,13,25,.65))',
      border: isLight ? '1px solid rgba(0,0,0,0.08)' : '1px solid rgba(255,255,255,0.10)',
      boxShadow: isLight ? '0 4px 16px rgba(0,0,0,0.08)' : '0 12px 34px rgba(0,0,0,.55)',
